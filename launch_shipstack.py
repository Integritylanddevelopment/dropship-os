...
SERVICES = {
    "shipstack_engine.py": 8889,
    "prometheus_engine.py": 8766,
    "social_ai_agent.py": 8867,
    "shipstack_dashboard.py": 8890,
}
...
def start_service(script_name: str, port: int) -> subprocess.Popen:
    ...
    script_path = DROPSHIP_OS_ROOT / script_name
